...
contract masterSLEC is IERC777Recipient {
    ...
    */
    ...
    struct energyStream {
        ...
        uint64 energy;   // amount of energy to buy or sell (unit?)
    }
    ...
    // buyEnergy_map is the list of energyStream structs documenting a desire to buy - indexed by the address of the stream's owner
